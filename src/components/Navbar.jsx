        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/dashboard" className="flex items-center gap-3 group">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="w-9 h-9 bg-[#2E3192] rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-terracotta transition-all duration-300"
            >
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            >
              ...
              <span className="absolute top-1.5 right-1.5 h-2 w-2 bg-[#2E3192] rounded-full" />
            </motion.button>
            ...
            <div className="relative">
              ...
              >
                <div className="h-8 w-8 bg-[#2E3192] rounded-lg flex items-center justify-center">
            ...
            <div className="px-4 pt-3 pb-5 space-y-1">
              ...
              <div className="pt-3 mt-3 border-t border-white/10">
                <div className="flex items-center gap-3 px-4 py-3 mb-1">
                  <div className="h-10 w-10 bg-[#2E3192] rounded-xl flex items-center justify-center">
